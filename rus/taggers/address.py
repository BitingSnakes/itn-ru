...
from rus.graph_utils import NEMO_NON_BREAKING_SPACE, NEMO_NOT_SPACE, GraphFst
...
class AddressFst(GraphFst):
    ...
    Finite state transducer for street addresses, e.g.
        улица шевченко дом пять квартира три
            -> name: "ул. шевченко, д. 5, кв. 3"
        проспект победы дом сто двадцать
            -> name: "просп. победы, д. 120"
    ...
    def __init__(self, cardinal: CardinalFst):
        ...
        # parts may be separated by an ASR comma: "улица шевченко , дом пять"
        ...
        graph = street + comma + sep + house + pynini.closure(comma + sep + building, 0, 1) + pynini.closure(comma + sep + apartment, 0, 1)
