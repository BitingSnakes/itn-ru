...
class OrdinalFst(GraphFst):
    def __init__(self, cardinal: CardinalFst):
        ...
        # Like: "двухтысячный год" -> "2000-й год".
        ...
        graph = pynini.union(
            graph_billions + delete_space_optional + graph_millions + delete_space_optional + graph_thousands + delete_space_optional + graph_hundred_component,
            one_thousand,
            ordinal_thousand,
