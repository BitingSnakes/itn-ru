...
class FractionFst(GraphFst):
    ...
    Finite state transducer for classifying common fractions,
        e.g. одна друга -> fraction { numerator: "1" denominator: "2" }
             две третьих -> fraction { numerator: "2" denominator: "3" }
             минус три двадцать пятых -> fraction { negative: "true" numerator: "3" denominator: "25" }
    ...
    def __init__(self, cardinal: CardinalFst):
        ...
        # compound denominators: двадцать пятая / двадцать пятых -> 25
        ...
        optional_minus = pynini.closure(pynutil.insert('negative: "true" ') + pynutil.delete("минус "), 0, 1)
