...
from rus.graph_utils import NEMO_CHAR, NEMO_DIGIT, GraphFst, delete_extra_space, delete_space
...
class DateFst(GraphFst):
    ...
    def __init__(self, cardinal: CardinalFst, ordinal: OrdinalFst):
        ...
        year_name = delete_extra_space + pynini.union("год", "года", "году")
        optional_year_name = pynini.closure(year_name, 0, 1)

        optional_epoch = delete_extra_space + pynini.closure("до ", 0, 1) + pynini.cross("нашей эры", "н. э.")
