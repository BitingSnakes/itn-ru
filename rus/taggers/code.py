...
class CodeFst(GraphFst):
    """
    Finite state transducer for zero-leading digit codes such as Russian
    postal codes, e.g.
    ...
    pinned to the postal-code format (exactly five digits), so it
    ...
    def __init__(self, cardinal: CardinalFst):
        ...
        number = cardinal.graph_zero + pynini.closure(delete_space + group, 1)
