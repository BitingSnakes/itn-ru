...
class CardinalFst(GraphFst):
    def __init__(self):
        ...
        graph_up_to_hundred_component = pynini.union(
            self.graph_teen, (self.graph_ties | pynutil.insert("0")) + delete_space_optional + (self.graph_digit | pynutil.insert("0"))
        )
        ...
        graph = graph @ pynini.union(
            pynini.closure(pynutil.delete(pynini.union("0", ","))) + pynini.difference(NEMO_DIGIT, "0") + pynini.closure(pynini.union(NEMO_DIGIT, ",")),
            "0",
        )
