...
from rus.utils import attach_punctuation, reorder, separate_punctuation
...
def _canonicalize_orthography(text: str):
    ...
    for token in text.split(" "):
        canonical = unicodedata.normalize("NFC", token).translate(_APOSTROPHE_TRANSLATION).lower()
...
class InverseNormalizer:
    ...
    def __init__(self):
        from rus.taggers.tokenize_and_classify import ClassifyFst
        from rus.verbalizers.verbalize_final import VerbalizeFinalFst
